					...
					<div class="row woocommerce-cart-form__cart-item <?php echo esc_attr( apply_filters( 'woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key ) ); ?>">
						<div class="col-sm-4 col-md-3">
							...
							if ( ! $product_permalink ) {
								...
								printf( '<a class="product-thumbnail-w" href="%s">%s</a>', esc_url( $product_permalink ), $thumbnail ); // PHPCS: XSS ok.
							}
							?>
						...
						<div class="col-sm-8 col-md-5">
							...
							<div class="prd-cart-rc">
								...
								echo apply_filters( // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
									...
									sprintf(
										'<a href="%s" class="remove" aria-label="%s" data-product_id="%s" data-product_sku="%s"><i class="icon-trash"></i>حذف</a>',
						...
						<div class="col-md-4">
						<div class="woocommerce-cart-form-price-box">
