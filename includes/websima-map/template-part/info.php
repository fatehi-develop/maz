...
<ul class="contact-info">
	<?php if($address):?>
    	<li class="address"><i class="icon-location"></i><a href="https://www.google.com/maps/dir/?api=1&amp;destination=<?php echo $lat;?>, <?php echo $lng;?>" target="_blank" rel="nofollow" ><?php echo esc_html($address); ?></a></li>
	<?php endif; ?>
	<?php if($phones): ?>
	    <li class="phone">
		<i class="icon-call"></i>
	...
	<?php endif; ?>
	<?php if($email): ?>
		<li class="email"><i class="icon-email"></i><a href="mailto:<?php echo esc_attr($email);?>"><?php echo esc_html($email);?></a></li>
	<?php endif; ?>
	<?php if($working_time): ?>
