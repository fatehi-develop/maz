...
class C4WP_Image {
	...
	public function c4wp_generate_captcha( ) {
		...
		$return .= '<a href="javascript:void(0);" class="refresh_captcha" data-imgsrc="'.$create_image_url . rand( 111, 99999 ) . '" rel="nofollow noreferrer" ><img src="'.get_template_directory_uri().'/includes/websima-captcha/assets/images/c4wp-refresh-captcha.png" class="c4wp-refresh-captcha"/></a>';
