...
function websima_scripts(){
	...
	if ( is_cart() || is_checkout() || is_wc_endpoint_url()  || is_order_received_page() || is_view_order_page() || is_account_page()) {
...
function websima_theme_setup(){
	...
	add_image_size( 'img_blog', 262,174,true );
	/* add_image_size( 'img_categories', 355,200,true );
	
	add_image_size( 'img_product', 260,195,true );
